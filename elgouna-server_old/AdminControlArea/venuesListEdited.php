...
if($venues_query) {
    ...
    $venues_rows = mysqli_num_rows($venues_query);
    if($venues_rows > 0) {
        
        $venues_arr = mysqli_fetch_array($venues_query);
        if(isset($_POST['pgid'])) {
        ...
        $pagenumber = ceil($venues_rows / $limit);
        $end = $start + $limit;
        $sql = "select *"
                . " from hotels"
                . " where hidden = 0"
...
<?php 
    ...
    $k = 0;
    while($row = mysqli_fetch_array($venues_query)) {
...
?>
            ...
            <td width="26">
                <a href="javascript:addNewItem('createNewHotel.php?id=
<?php 
...
?>
                ...
                <a href="#myModal" onclick="deleteItem('deleteHotel.php','
<?php 
...
?>
                    ','1')" role="button" data-toggle="modal">
                    <i class="icon-remove">
                    </i>
                </a> 
<?php 
...
?>
            <li>
                <a href="javascript:ListFn('
<?php 

                    echo $ID - 1;
                    
?>
                   ','hotelsList.php');" title="Previous Page">« Prev.
                </a>
            </li>
<?php 
...
?>
                   ','hotelsList.php');" style="background-color:#F4F4F4"  title="
<?php  
...
?>
                   ','hotelsList.php');" title="Next Page">Next »
                </a>
            </li>
<?php 
