...
$( document ).ready(function() {
   ListFn('<?php echo $_GET['pgid'];?>','beachesList.php');
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Manage Beaches</h1>
        </div>
        
                <!--<ul class="breadcrumb">-->
            <!--<li><a href="home.php">Home</a> <span class="divider">/</span></li>-->
            <!--<li class="active"><a href="javascript:ListFn('0','beachesList.php');">Beaches List</a></li>-->
        <!--</ul>-->
...
<div class="btn-toolbar"  id="addingDiv">
    <button class="btn btn-primary" onClick="javascript:addNewItem('createNewBeach.php','')"><i class="icon-plus"></i> Add New Beach</button>
  <div class="btn-group">
  </div>
</div>
