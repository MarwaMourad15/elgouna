              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                      ...
                      <tr>
                        <td><table width="100%" border="0" cellspacing="5" cellpadding="5">
                            ...
                            <tr>
                              ...
                              <td><strong>Booking URL: </strong></td>
                              <td><input type="text" name="booking-url" id="booking-url" value="<?php echo $row['bookingLink'];?>" class="input-xlarge" style=" "/></td>
                              <td>&nbsp;</td>
                              <td>&nbsp;</td>
                            </tr>
                        </table></td>
                ...
                <tr>
                  <td><table border="0" cellspacing="5" cellpadding="5">
					  ...
					  ?>
                        <td><input  name="check<?php echo $row_s['id'];?>" type="checkbox" class="input-xlarge " id="check<?php echo $row_s['id'];?>" style="direction:rtl" value="<?php echo $row_s['id'];?>" <?php if($n_ex!=0){echo "checked";}?>/></td>
                        <td><strong>
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="5" cellpadding="5">
                      ...
                      <tr>
                        ...
                        <td><strong>Virtual Tour Link: </strong></td>
                        <td><input type="text"  name="vtour" id="vtour" value="<?php echo $row['virtualTourLink'];?>" class="input-xlarge" style=" "/></td>
                        <td>&nbsp;</td>
                      </tr>
                  </table></td>
                </tr>
