...
$( document ).ready(function() {
   ListFn('<?php echo $_GET['pgid'];?>','contactList.php');
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Manage Contact us Inquiries</h1>
        </div>
        
                <!--<ul class="breadcrumb">-->
            <!--<li><a href="home.php">Home</a> <span class="divider">/</span></li>-->
            <!--<li class="active"><a href="javascript:ListFn('0','contactList.php');">Inquiry List</a></li>-->
        <!--</ul>-->
