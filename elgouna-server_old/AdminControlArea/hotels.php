...
$( document ).ready(function() {
   ListFn('<?php echo $_GET['pgid'];?>','hotelsList.php');
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <li class="active"><a href="javascript:ListFn('0','hotelsList.php');">Hotels List</a></li>
        </ul>
...
<div class="btn-toolbar"  id="addingDiv">
    <button class="btn btn-primary" onClick="javascript:addNewItem('createNewHotel.php','')"><i class="icon-plus"></i> Add New Hotel</button>
  <div class="btn-group">
  </div>
</div>
