  ...
  <!--  <link rel="stylesheet" href="/resources/demos/style.css"/>-->
    ...
    <script>
      $(document).ready(function () {
        ListFn('<?php echo $_GET['pgid'];?>', 'usersList.php');
...
<div class="content">
  ...
  <div class="header">
    ...
    <h1 class="page-title">Manage User's Accounts</h1>
  </div>

  <ul class="breadcrumb">
    <li><a href="home.php">Home</a> <span class="divider">/</span></li>
    <li class="active"><a href="javascript:ListFn('0','usersList.php');">Users List</a></li>
  </ul>
