                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="type" id="type"  
                                                        ...
                                                        <option value="club" <?php if($id_received) { echo $venue_to_be_updated_arr['type'] == 'club' ? 'selected' : ''; } ?>>
                                                            Club
                                                        </option>
                                                    </select>
                                                </td>
...
?>
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" cellspacing="5" cellpadding="5" class="fields" style="margin-top:20px">
<?php if(!$id_received) { ?>
                                <tr style="background: #ededed;">
                                    <td valign="top">
                                        <label>
                                            <strong>Logo</strong><asterisk>*</asterisk>
                                        </label>
...
?>
                                ...
                                <tr style="background: whitesmoke">
                                    <td valign="top">
                                        <label>
                                            <strong>Main Image:</strong><asterisk>*</asterisk>
                                        </label>
                                    </td>
                                    <td style='white-space:nowrap' valign="middle">
<?php
...
?>
                                        ...
                                        <img src="e.png" id="alter-main-img" name="main-img" style="margin-left:30px;
                                                cursor:pointer" />
                                        <div id="file-text-main-img" class="file-text"/>
                                        <?= $dir . $venue_to_be_updated_main_image ?>
<?php
...
<?php
                ...
                $images_offset = 3;
                $venue_to_be_updated_images_sql = "select * " . "from `venues_img` " . "where `venue_id` = '$venue_to_be_updated_id' " . "order by id asc " . "limit 10 " . "offset 2";
...
?>
                                    ...
                                    <td valign="top">
                                        <input type="file" name="venue-imgs[]" id="venue-img-<?php echo $i ?>" class="input-xlarge" />
                                    </td>
<?php
